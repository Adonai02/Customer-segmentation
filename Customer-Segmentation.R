...
hist(data$Age, col = "royalblue", xlab = "Age", main = "Histograma de Edad")
...
plot(density(data$Annual.Income..k..),main = "", xlab = "Income") 
polygon(density(data$Annual.Income..k..),col = "red")
...
plot(x = data_clustering$IncomeAnnual, y = data_clustering$SpendingScore)
...
kmeans_tot_withinss
plot(c(1:10), kmeans_tot_withinss, type = "o")
